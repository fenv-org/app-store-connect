 ...
 * no description
 */
export class BuildBetaDetailsApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async buildBetaDetailsBuildGetToOneRelated(id: string, fieldsBuilds?: Array<'app' | 'appEncryptionDeclaration' | 'appStoreVersion' | 'betaAppReviewSubmission' | 'betaBuildLocalizations' | 'betaGroups' | 'buildAudienceType' | 'buildBetaDetail' | 'buildBundles' | 'computedMinMacOsVersion' | 'diagnosticSignatures' | 'expirationDate' | 'expired' | 'iconAssetToken' | 'icons' | 'individualTesters' | 'lsMinimumSystemVersion' | 'minOsVersion' | 'perfPowerMetrics' | 'preReleaseVersion' | 'processingState' | 'uploadedDate' | 'usesNonExemptEncryption' | 'version'>, _options?: Configuration): Promise<RequestContext> {
        ...
        if (id === null || id === undefined) {
            throw new RequiredError("BuildBetaDetailsApi", "buildBetaDetailsBuildGetToOneRelated", "id");
        }



        // Path Params
        const localVarPath = '/v1/buildBetaDetails/{id}/build'
    ...
    public async buildBetaDetailsGetCollection(filterBuild?: Array<string>, filterId?: Array<string>, fieldsBuildBetaDetails?: Array<'autoNotifyEnabled' | 'build' | 'externalBuildState' | 'internalBuildState'>, limit?: number, include?: Array<'build'>, fieldsBuilds?: Array<'app' | 'appEncryptionDeclaration' | 'appStoreVersion' | 'betaAppReviewSubmission' | 'betaBuildLocalizations' | 'betaGroups' | 'buildAudienceType' | 'buildBetaDetail' | 'buildBundles' | 'computedMinMacOsVersion' | 'diagnosticSignatures' | 'expirationDate' | 'expired' | 'iconAssetToken' | 'icons' | 'individualTesters' | 'lsMinimumSystemVersion' | 'minOsVersion' | 'perfPowerMetrics' | 'preReleaseVersion' | 'processingState' | 'uploadedDate' | 'usesNonExemptEncryption' | 'version'>, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/v1/buildBetaDetails';
    ...
    public async buildBetaDetailsGetInstance(id: string, fieldsBuildBetaDetails?: Array<'autoNotifyEnabled' | 'build' | 'externalBuildState' | 'internalBuildState'>, include?: Array<'build'>, fieldsBuilds?: Array<'app' | 'appEncryptionDeclaration' | 'appStoreVersion' | 'betaAppReviewSubmission' | 'betaBuildLocalizations' | 'betaGroups' | 'buildAudienceType' | 'buildBetaDetail' | 'buildBundles' | 'computedMinMacOsVersion' | 'diagnosticSignatures' | 'expirationDate' | 'expired' | 'iconAssetToken' | 'icons' | 'individualTesters' | 'lsMinimumSystemVersion' | 'minOsVersion' | 'perfPowerMetrics' | 'preReleaseVersion' | 'processingState' | 'uploadedDate' | 'usesNonExemptEncryption' | 'version'>, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("BuildBetaDetailsApi", "buildBetaDetailsGetInstance", "id");
        }
        ...
        // Path Params
        const localVarPath = '/v1/buildBetaDetails/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public async buildBetaDetailsUpdateInstance(id: string, buildBetaDetailUpdateRequest: BuildBetaDetailUpdateRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("BuildBetaDetailsApi", "buildBetaDetailsUpdateInstance", "id");
        }
        ...
        if (buildBetaDetailUpdateRequest === null || buildBetaDetailUpdateRequest === undefined) {
            throw new RequiredError("BuildBetaDetailsApi", "buildBetaDetailsUpdateInstance", "buildBetaDetailUpdateRequest");
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(buildBetaDetailUpdateRequest, "BuildBetaDetailUpdateRequest", ""),
            contentType
        );
...
export class BuildBetaDetailsApiResponseProcessor {

    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     * @params response Response returned by the server for a request to buildBetaDetailsBuildGetToOneRelated
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async buildBetaDetailsBuildGetToOneRelatedWithHttpInfo(response: ResponseContext): Promise<HttpInfo<BuildWithoutIncludesResponse >> {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to buildBetaDetailsGetCollection
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async buildBetaDetailsGetCollectionWithHttpInfo(response: ResponseContext): Promise<HttpInfo<BuildBetaDetailsResponse >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("400", response.httpStatusCode)) {
            const body: ErrorResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
        ...
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: BuildBetaDetailsResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to buildBetaDetailsGetInstance
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async buildBetaDetailsGetInstanceWithHttpInfo(response: ResponseContext): Promise<HttpInfo<BuildBetaDetailResponse >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("400", response.httpStatusCode)) {
            const body: ErrorResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to buildBetaDetailsUpdateInstance
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async buildBetaDetailsUpdateInstanceWithHttpInfo(response: ResponseContext): Promise<HttpInfo<BuildBetaDetailResponse >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("400", response.httpStatusCode)) {
            const body: ErrorResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
