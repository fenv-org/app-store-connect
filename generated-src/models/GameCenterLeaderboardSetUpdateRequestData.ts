...
export class GameCenterLeaderboardSetUpdateRequestData {
    ...
    static getAttributeTypeMap() {
        return GameCenterLeaderboardSetUpdateRequestData.attributeTypeMap;
    }
...
export enum GameCenterLeaderboardSetUpdateRequestDataTypeEnum {
