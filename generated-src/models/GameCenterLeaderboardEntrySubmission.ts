...
export class GameCenterLeaderboardEntrySubmission {
    ...
    static getAttributeTypeMap() {
        return GameCenterLeaderboardEntrySubmission.attributeTypeMap;
    }
...
export enum GameCenterLeaderboardEntrySubmissionTypeEnum {
