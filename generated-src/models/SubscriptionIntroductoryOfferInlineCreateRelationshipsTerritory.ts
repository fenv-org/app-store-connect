...
export class SubscriptionIntroductoryOfferInlineCreateRelationshipsTerritory {
    ...
    static getAttributeTypeMap() {
        return SubscriptionIntroductoryOfferInlineCreateRelationshipsTerritory.attributeTypeMap;
    }
