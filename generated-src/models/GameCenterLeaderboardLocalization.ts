...
export class GameCenterLeaderboardLocalization {
    ...
    static getAttributeTypeMap() {
        return GameCenterLeaderboardLocalization.attributeTypeMap;
    }
...
export enum GameCenterLeaderboardLocalizationTypeEnum {
