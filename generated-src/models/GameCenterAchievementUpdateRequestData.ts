...
export class GameCenterAchievementUpdateRequestData {
    ...
    static getAttributeTypeMap() {
        return GameCenterAchievementUpdateRequestData.attributeTypeMap;
    }
...
export enum GameCenterAchievementUpdateRequestDataTypeEnum {
