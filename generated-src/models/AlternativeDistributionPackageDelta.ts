...
export class AlternativeDistributionPackageDelta {
    ...
    static getAttributeTypeMap() {
        return AlternativeDistributionPackageDelta.attributeTypeMap;
    }
...
export enum AlternativeDistributionPackageDeltaTypeEnum {
