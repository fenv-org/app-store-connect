...
export class GameCenterMatchmakingQueueCreateRequestDataRelationshipsExperimentRuleSet {
    ...
    static getAttributeTypeMap() {
        return GameCenterMatchmakingQueueCreateRequestDataRelationshipsExperimentRuleSet.attributeTypeMap;
    }
