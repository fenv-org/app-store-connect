...
export class AlternativeDistributionPackageCreateRequestDataRelationships {
    ...
    static getAttributeTypeMap() {
        return AlternativeDistributionPackageCreateRequestDataRelationships.attributeTypeMap;
    }
