...
export class GameCenterLeaderboardSetGameCenterLeaderboardsLinkagesResponse {
    ...
    static getAttributeTypeMap() {
        return GameCenterLeaderboardSetGameCenterLeaderboardsLinkagesResponse.attributeTypeMap;
    }
