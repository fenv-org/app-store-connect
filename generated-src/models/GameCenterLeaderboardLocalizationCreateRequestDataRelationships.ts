...
export class GameCenterLeaderboardLocalizationCreateRequestDataRelationships {
    ...
    static getAttributeTypeMap() {
        return GameCenterLeaderboardLocalizationCreateRequestDataRelationships.attributeTypeMap;
    }
