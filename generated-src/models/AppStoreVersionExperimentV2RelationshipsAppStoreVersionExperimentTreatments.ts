...
export class AppStoreVersionExperimentV2RelationshipsAppStoreVersionExperimentTreatments {
    ...
    static getAttributeTypeMap() {
        return AppStoreVersionExperimentV2RelationshipsAppStoreVersionExperimentTreatments.attributeTypeMap;
    }
