...
export class GameCenterLeaderboardSetReleaseCreateRequestDataRelationships {
    ...
    static getAttributeTypeMap() {
        return GameCenterLeaderboardSetReleaseCreateRequestDataRelationships.attributeTypeMap;
    }
