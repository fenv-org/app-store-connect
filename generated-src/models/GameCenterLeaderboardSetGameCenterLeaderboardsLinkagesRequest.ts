...
export class GameCenterLeaderboardSetGameCenterLeaderboardsLinkagesRequest {
    ...
    static getAttributeTypeMap() {
        return GameCenterLeaderboardSetGameCenterLeaderboardsLinkagesRequest.attributeTypeMap;
    }
