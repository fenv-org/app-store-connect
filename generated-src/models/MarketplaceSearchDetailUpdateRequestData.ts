...
export class MarketplaceSearchDetailUpdateRequestData {
    ...
    static getAttributeTypeMap() {
        return MarketplaceSearchDetailUpdateRequestData.attributeTypeMap;
    }
...
export enum MarketplaceSearchDetailUpdateRequestDataTypeEnum {
