...
export class GameCenterLeaderboardSetGroupLeaderboardSetLinkageRequest {
    ...
    static getAttributeTypeMap() {
        return GameCenterLeaderboardSetGroupLeaderboardSetLinkageRequest.attributeTypeMap;
    }
