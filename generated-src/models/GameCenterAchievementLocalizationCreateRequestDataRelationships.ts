...
export class GameCenterAchievementLocalizationCreateRequestDataRelationships {
    ...
    static getAttributeTypeMap() {
        return GameCenterAchievementLocalizationCreateRequestDataRelationships.attributeTypeMap;
    }
