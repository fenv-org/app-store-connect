...
export class AlternativeDistributionPackageVersionRelationshipsVariants {
    ...
    static getAttributeTypeMap() {
        return AlternativeDistributionPackageVersionRelationshipsVariants.attributeTypeMap;
    }
