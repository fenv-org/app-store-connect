...
export class GameCenterAppVersionCompatibilityVersionsLinkagesResponse {
    ...
    static getAttributeTypeMap() {
        return GameCenterAppVersionCompatibilityVersionsLinkagesResponse.attributeTypeMap;
    }
