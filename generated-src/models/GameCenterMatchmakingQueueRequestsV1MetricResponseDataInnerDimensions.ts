...
export class GameCenterMatchmakingQueueRequestsV1MetricResponseDataInnerDimensions {
    ...
    static getAttributeTypeMap() {
        return GameCenterMatchmakingQueueRequestsV1MetricResponseDataInnerDimensions.attributeTypeMap;
    }
