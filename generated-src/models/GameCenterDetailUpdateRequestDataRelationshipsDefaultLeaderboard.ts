...
export class GameCenterDetailUpdateRequestDataRelationshipsDefaultLeaderboard {
    ...
    static getAttributeTypeMap() {
        return GameCenterDetailUpdateRequestDataRelationshipsDefaultLeaderboard.attributeTypeMap;
    }
