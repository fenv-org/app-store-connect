...
export class AlternativeDistributionPackageCreateRequestDataRelationshipsAppStoreVersion {
    ...
    static getAttributeTypeMap() {
        return AlternativeDistributionPackageCreateRequestDataRelationshipsAppStoreVersion.attributeTypeMap;
    }
