...
export class GameCenterMatchmakingTestRequestInlineCreateRelationships {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "matchmakingPlayerProperties",
            "baseName": "matchmakingPlayerProperties",
            "type": "GameCenterMatchmakingTestRequestInlineCreateRelationshipsMatchmakingPlayerProperties",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return GameCenterMatchmakingTestRequestInlineCreateRelationships.attributeTypeMap;
    }
