...
export class GameCenterAchievementCreateRequestDataRelationshipsGameCenterDetail {
    ...
    static getAttributeTypeMap() {
        return GameCenterAchievementCreateRequestDataRelationshipsGameCenterDetail.attributeTypeMap;
    }
