...
export class GameCenterMatchmakingQueueCreateRequestDataRelationshipsRuleSet {
    ...
    static getAttributeTypeMap() {
        return GameCenterMatchmakingQueueCreateRequestDataRelationshipsRuleSet.attributeTypeMap;
    }
