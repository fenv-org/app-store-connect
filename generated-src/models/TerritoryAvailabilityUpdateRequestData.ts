...
export class TerritoryAvailabilityUpdateRequestData {
    ...
    static getAttributeTypeMap() {
        return TerritoryAvailabilityUpdateRequestData.attributeTypeMap;
    }
...
export enum TerritoryAvailabilityUpdateRequestDataTypeEnum {
