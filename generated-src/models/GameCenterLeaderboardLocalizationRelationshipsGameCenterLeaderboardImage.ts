...
export class GameCenterLeaderboardLocalizationRelationshipsGameCenterLeaderboardImage {
    ...
    static getAttributeTypeMap() {
        return GameCenterLeaderboardLocalizationRelationshipsGameCenterLeaderboardImage.attributeTypeMap;
    }
