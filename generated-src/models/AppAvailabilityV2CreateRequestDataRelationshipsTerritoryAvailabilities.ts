...
export class AppAvailabilityV2CreateRequestDataRelationshipsTerritoryAvailabilities {
    ...
    static getAttributeTypeMap() {
        return AppAvailabilityV2CreateRequestDataRelationshipsTerritoryAvailabilities.attributeTypeMap;
    }
