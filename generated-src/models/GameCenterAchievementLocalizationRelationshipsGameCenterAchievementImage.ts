...
export class GameCenterAchievementLocalizationRelationshipsGameCenterAchievementImage {
    ...
    static getAttributeTypeMap() {
        return GameCenterAchievementLocalizationRelationshipsGameCenterAchievementImage.attributeTypeMap;
    }
