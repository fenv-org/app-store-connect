...
export class GameCenterDetailGameCenterLeaderboardSetsLinkagesResponse {
    ...
    static getAttributeTypeMap() {
        return GameCenterDetailGameCenterLeaderboardSetsLinkagesResponse.attributeTypeMap;
    }
